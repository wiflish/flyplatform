...
<script type="text/javascript">
    ...
    $(function(){
      ...
      $("#div-show-today").html("Today is " + $.datepicker.formatDate("yy-mm-dd DD", new Date(), null ) );
    });
    </script>
</head>
	...
	<div region="north" style="height: 85px; border: 0;">
		<div class="easyui-layout" fit="true">
            ...
            <div region="south" style="height:28px;background:#efefef;border-top:0;border-bottom:0">
                <div class="easyui-layout" fit="true">
                    <div region="west" style="width:220px;line-height: 25px;" border="false" id="div-show-today"></div>
                    <div region="center" style="line-height: 25px;" border="false">Function Shortcut</div>
                    <div region="east" style="width:200px;text-align: right;" border="false">
                        <a href="#" class="easyui-linkbutton" iconCls="icon-modify-pwd" plain="true">ModifyPassword</a>
                        <a href="#" class="easyui-linkbutton" iconCls="icon-logout" plain="true">Logout</a>
                    </div>
                </div>
            </div>
        </div>
